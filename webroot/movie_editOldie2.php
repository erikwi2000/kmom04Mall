...
//$fromdb = $handle->GetDBaseMovieEdit($bwix['database']);
...
//$sql ='INSERT INTO Movie2Genre (idMovie, idGenre) VALUES   (6, 1)';
...
if($save) {
  $sql = '
    ...
    WHERE 
      id = ?
  ';
  //$sql ='INSERT INTO Movie2Genre (idMovie, idGenre) VALUES   (13, 1)';
...
/*
 <p><label>Genre:<br/><input type='text' list=genre name='genre' value='{$movie->genre}'/></label>
<datalist id=genre>
<option value=comedy>
