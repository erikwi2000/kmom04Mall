...
include(BWI_INSTALL_PATH . '/src/bootstrap.flimmer.php');
...
$bwix['stylesheets'] = array('css/style.flimmer.css');
...
//dump('header');
$bwix['footer'] = <<<EOD
<footer><span class='sitefooter'>Copyright (c) Björn Wiklund (erikwi2000@gmail.com) |
 Björn Viklund (bjvi13@student.bth.se)  | 
